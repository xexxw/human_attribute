...
def inception_iccv(pretrained=False, debug=False, **kwargs):
    ...
    """
    if pretrained:
        pretrained_dict = torch.load('/home/llj/PycharmProjects/pythonProject/iccv19_attribute/iccv19_attribute-master/pretrained-models.pytorch-master/pretrainedmodels/checkpoint/bn_inception-52deb4733.pth')
